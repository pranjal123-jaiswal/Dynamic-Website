...
import Baseurl from "../../Baseurl";import newImg from "../../Images/Group 38051.png";
          ...
          {products.map((item , key) => (
              ...
              <div className="left">
                ...
                <div className="second">
                  ...
                  {item?.reviews.map((review, key) => (
                    <div key={key}>
                                <ul style={{ listStyle: "disc" }}>
                    <li>{review}</li>
                      {/* Additional <li> items can be added here if needed */}
                     </ul>
                         </div>
                      ))}
              ...
              <div className="right">
                ...
                <div className="down">
                  <p className="thorught"> {item?.price}</p>
                ...
                <p style={{fontSize : '14px'}}>Upto <strong>{item?.price}</strong> off on Exchange</p>
              </div>
            </div>
            ))}
